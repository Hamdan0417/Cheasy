...
if( ! defined('sSHIP_VERSION') ) define( 'sSHIP_VERSION', '2.0.5' );
...
if( ! defined('sSHIP_CODE') )    define( 'sSHIP_CODE', getionshipcode() );
if( ! defined('sSHIP_ERROR') )   define( 'sSHIP_ERROR', sship_check_server() );


function getionshipcode(){
...
function sship_check_server() {
    ...
    if( ! array_key_exists( 'alids/alids.php', $plugins_global ) &&
        ! array_key_exists( 'alidswoo/alidswoo.php', $plugins_global  ) && ! in_array( 'alids/alids.php', $plugins_local ) &&
