					...
					<?php if ( wc_coupons_enabled() ) { ?>
						<div class="coupon nicelabel">
                            <div class="form-group d-inline-block mb-0">
                                ...
                                <label for="coupon_code"><?php esc_html_e( 'Coupon Code', 'elgrecowoo' ); ?></label>
                            </div>
                            <button type="submit" class="btn btn-secondary" name="apply_coupon" value="<?php esc_attr_e( 'Apply', 'elgrecowoo' ); ?>"><?php esc_attr_e( 'Apply', 'elgrecowoo' ); ?></button>
        ...
        <?php if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
            <p class="return-to-shop">
                <a class="" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
                    <i class="icon-left-open"></i>&nbsp;<?php esc_html_e( 'Continue Shopping', 'elgrecowoo' ); ?>
                </a>
            </p>
        <?php endif; ?>
    </div>
