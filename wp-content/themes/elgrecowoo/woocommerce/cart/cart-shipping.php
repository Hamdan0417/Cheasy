                        ...
                        <?php if ( is_cart() ) : ?>
                            <p class="woocommerce-shipping-destination">
                                ...
                                if ( $formatted_destination ) {
                                    ...
                                    printf( esc_html__( 'Estimate for %s.', 'elgrecowoo' ) . ' ', '<strong>' . esc_html( $formatted_destination ) . '</strong>' );
                                    $calculator_text = __( 'Change address', 'woocommerce' );
                                } else {
                                    echo esc_html__( 'This is only an estimate. Prices will be updated during checkout.', 'elgrecowoo' );
                                }
                                ?>
                            </p>
                        <?php endif; ?>
