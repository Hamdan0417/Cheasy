...
if ( $attachment_ids ) {
    ...
    if($thumb_count <= 5 && $direction == 'vertical'){
   ...
   <div class="<?php echo implode(' ', $gallery_class); ?>" data-count="<?php echo $thumb_count; ?>" data-columns="<?php echo $columns?>">
        <div class=" product-main-slider-thumbs">
                ...
                <?php
                do_action('adswth_product_main_slider_first_thumb');
                ...
                foreach ( $attachment_ids as $key => $attachment_id ) {
                    ...
                    echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<div class="slide"><a class="image-wrap"><div class="image-inner">%s</div></a></div>', $image ), $attachment_id, $post->ID, $image_class );

                    $loop++;
                }
                endif; ?>
                <?php do_action('adswth_product_main_slider_last_thumb'); ?>
        </div>
