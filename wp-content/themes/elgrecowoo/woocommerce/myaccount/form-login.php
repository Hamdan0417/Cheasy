...
<?php endif; ?>
		...
		<h3 class="text-uppercase text-center mb-px-15"><?php esc_html_e( 'Returning customer', 'elgrecowoo' ); ?></h3>
            ...
            <div class="col-md-8 col-lg-10 col-xl-8">
                ...
                <form class="nicelabel login" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <label for="username"><span class="required">*</span><?php esc_html_e( 'Your login or email', 'elgrecowoo' ); ?></label>
                    </div>
                    <div class="form-group">
                        ...
                        <label for="password"><span class="required">*</span><?php esc_html_e( 'Password', 'elgrecowoo' ); ?></label>
                    </div>
                    ...
                    <div class="row justify-content-between mt-2">
                        <div class="col-auto font-12">
                            <label class="checkbox woocommerce-form__label woocommerce-form__label-for-checkbox inline">
                                <input class="woocommerce-form__input woocommerce-form__input-checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> <span><?php esc_html_e( 'Remember me', 'elgrecowoo' ); ?></span>
                            </label>
                        </div>
                        <div class="col-auto font-12">
                            <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Forgot password', 'elgrecowoo' ); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="form-submit text-center mt-xl-px-30 mt-lg-px-25 mt-md-px-20">
                        ...
                        <button type="submit" class="btn btn-secondary" name="login" value="<?php esc_attr_e( 'Log in', 'elgrecowoo' ); ?>"><?php esc_html_e( 'Log in', 'elgrecowoo' ); ?></button>
                    </div>
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="col-lg-6 mt-md-px-30 mt-sm-px-30 mt-xs-px-30">
		...
		<h3 class="text-uppercase text-center mb-px-15"><?php esc_html_e( 'Register', 'elgrecowoo' ); ?></h3>
            ...
            <div class="col-md-8 col-lg-10 col-xl-8">
                <form method="post" class="nicelabel register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
                    ...
                    <div class="form-group">
                        ...
                        <label for="reg_username"><span class="required">*</span><?php esc_html_e( 'Username', 'elgrecowoo' ); ?></label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="reg_email"><span class="required">*</span><?php esc_html_e( 'Email', 'elgrecowoo' ); ?></label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="reg_password"><span class="required">*</span><?php esc_html_e( 'Password', 'elgrecowoo' ); ?></label>
                    </div>
                    ...
                    <div class="form-submit text-center mt-xl-px-30 mt-lg-px-25 mt-md-px-20">
                        ...
                        <button type="submit" class="btn btn-secondary" name="register" value="<?php esc_attr_e( 'Create an Account', 'elgrecowoo' ); ?>"><?php esc_html_e( 'Create an Account', 'elgrecowoo' ); ?></button>
                    </div>
