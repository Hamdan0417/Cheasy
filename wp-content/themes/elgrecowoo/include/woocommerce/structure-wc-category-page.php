    ...
    <?php
	    if( is_active_sidebar( 'woocommece-shop-sidebar' ) ) {  ?>
            <div class="col-xl-3 left-sidebar">
                <?php ?>
                <div id="woocommece-shop-sidebar" class="woocommece-shop-sidebar" data-all-categories-text="<?php esc_html_e('All categories', 'elgrecowoo') ?>">
                    <div class="sidebar-header d-xl-none">
                        <h2><?php _e( 'Filters', 'elgrecowoo' ); ?></h2>
                        <a href="javascript:;" class="close-btn">&times;</a>
                    </div>
                    <div class="woocommece-shop-sidebar-content">
                        <div class="left-sidebar-mobile-menu d-xl-none">
                            <div class="shop-mobile-menu-wrap" data-see="<?php _e( 'See All', 'elgrecowoo' ) ?>" data-shop="<?php _e( 'Shop', 'monetwoo' ) ?>"></div>
                        </div>
