 ...
 */
?>
<div data-thumb="<?php echo $thumbnail ?>" class="woocommerce-product-gallery__image item-video slide alids-woo-product-video <?=$video_type ? 'video-type-' . $video_type : ''?>">
    <?php if($video_type == 'youtube'){ ?>
        <iframe width="100%" height="400px" src="<?=$video_embed?>" data-src="<?=$video_embed?>" frameborder="0" allowfullscreen></iframe>
