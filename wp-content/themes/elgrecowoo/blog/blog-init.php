...
function adswth_blog_scripts() {
    ...
    if( is_blog() || is_blog_search() ){
        ...
        wp_enqueue_style( 'adswth-css-blog', ADSW_THEME_URL . '/blog/assets/css/style' . ADSW_THEME_MIN . '.css', [ 'elgrecowoo-style' ], ADSW_THEME_VERSION, 'all' );


        wp_enqueue_script( 'adswth-js-blog', ADSW_THEME_URL .'/blog/assets/js/blog' . ADSW_THEME_MIN . '.js', [ 'jquery' ], ADSW_THEME_VERSION, true );
        wp_enqueue_script( 'adswth-js-search-post', ADSW_THEME_URL .'/blog/assets/js/search-post' . ADSW_THEME_MIN . '.js', [ 'jquery', 'adswth-js-blog' ], ADSW_THEME_VERSION, true );
        ...
        if( is_single() ){
            if( is_woocommerce_activated() ){
                wp_enqueue_style( 'elgrecowoo-css-shop' );
...
function adswth_blog_widgets_init() {
    ...
    register_sidebar( [
        'name'          => __( 'Blog footer sidebar', 'elgrecowoo' ),
        'id'            => 'blog-footer-sidebar',
        'description'   => __( 'Blog footer social media icons by ADS Social Tools', 'elgrecowoo' ),
...
function adswth_blog_post_metaboxes( $post_type, $post ){
    ...
    add_meta_box( 'adswth-linked-products', __( 'Linked Products', 'elgrecowoo' ), 'adswth_render_linked_products', 'post', 'normal', 'high' );
}
